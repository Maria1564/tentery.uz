...
<?if (LANGUAGE_ID == 'ru') {?>
  ...
  <!-- E-mail -->
  <br />
  <input type='text' name='contact[email]' value='' id="ml"   placeholder="Ваш e-mail"/>
...
<div onclick="check();"class="button button--blue">Отправить</div>
...
<form method='POST' class='s2 bottom-form'  id="<?=$elID;?>"  action="/send_post.php">
  ...
  <!-- E-mail -->
  <br />
  <input type='text' name='contact[email]' value='' id="ml"  placeholder="Sizning elektron pochtangiz"/>
